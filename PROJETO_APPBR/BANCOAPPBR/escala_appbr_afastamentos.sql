...
CREATE TABLE `afastamentos` (
  ...
  `ID_TIPO_AFASTAMENTO` int NOT NULL,
  `OBSERVACAO` varchar(300) DEFAULT NULL,
  PRIMARY KEY (`ID_AFASTAMENTO`),
  KEY `ID_MILITAR` (`ID_MILITAR`),
  KEY `ID_TIPO_AFASTAMENTO` (`ID_TIPO_AFASTAMENTO`),
  CONSTRAINT `afastamentos_ibfk_1` FOREIGN KEY (`ID_MILITAR`) REFERENCES `efetivo` (`IDMILITAR`),
  CONSTRAINT `afastamentos_ibfk_2` FOREIGN KEY (`ID_TIPO_AFASTAMENTO`) REFERENCES `tipos_afastamento` (`IDTIPO_AFASTAMENTO`)
