...
CREATE TABLE `pessoa_funcao` (
  `IDPESSOA_FUNCAO` int NOT NULL AUTO_INCREMENT,
  `ID_MILITAR` int NOT NULL,
  `ID_FUNCAO` int NOT NULL,
  PRIMARY KEY (`IDPESSOA_FUNCAO`),
  KEY `ID_MILITAR` (`ID_MILITAR`),
  KEY `ID_FUNCAO` (`ID_FUNCAO`),
  CONSTRAINT `pessoa_funcao_ibfk_1` FOREIGN KEY (`ID_MILITAR`) REFERENCES `efetivo` (`IDMILITAR`),
  CONSTRAINT `pessoa_funcao_ibfk_2` FOREIGN KEY (`ID_FUNCAO`) REFERENCES `funcoes` (`IDFUNCAO`)
